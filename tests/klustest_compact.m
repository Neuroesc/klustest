...
%% For each part       
        for pp = 1:nparts % for every partition
            ...
            pspt = spiketime(sindax); % spike t for this part
...
%             sdata.celldata.(uci).(part_now).theta_skip = theta_skip;
            ...
            sdata.celldata.(uci).(part_now).theta_train_long = [(1:10') (1:10') (1:10')];
            sdata.celldata.(uci).(part_now).theta_index = NaN;
            sdata.celldata.(uci).(part_now).theta_ratio = NaN;
            sdata.celldata.(uci).(part_now).theta_skip = NaN;            
