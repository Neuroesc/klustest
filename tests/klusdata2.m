function klusdata2(tetrodes,clusters)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   This function utilises many minor functions to both analyse cluster data generated 
%   in Tint. It will output a session data structure: sdata.mat.
...
%   24/11/16 modified so that the figure plotting/processing is in a seperate function, so more easily handle the mix of 2D and 3D data
...
%% Waveforms
                    ...
                    sdata.(tet_s).(clu_s).(goal_now).wave_mins = min_wav; % add data to structure
