function mtint = readDACQDATA_multi(filepath,filename,cname,tetrodes)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%   mtint = readDACQDATA_multi(filepath,filename,cname,tetrodes)
%
%%%%%%%% Inputs
...
if numel(fileStruct) > 1 % if there are multiple session files
    ...
    mtint = readDACQdata(filepath,fileStruct.flnmroot,tetrodes);
