...
%% Prepare default settings
    ...
    def_part_names              = {'T1','T2dark','T3','All'}; % the names you want the outputs to be saved as, these cannot start with a number: i.e. 'session1'
    ...
    def_part_methods            = [2 2 2 2]; % i.e. if part_methods=[2 2 2 1], we will have 4 parts, the first 3 correspond to some combination of recording sessions (there can be multiple ones) and the last one will include all data
    ...
    def_part_intervals          = {1 2 3 [1:3]}; % i.e. if part_methods=[2 2 2], then if part_intervals={1 2 3}, rec 1 will go in part 1, rec 2 in part 2 and rec 3 in part 3    OR     if part_methods=[2 2 2 2 2], then if part_intervals={1 [2 4 5] 3}, rec 1 will go in part 1, rec 2,4 and 5 in part 2 and rec 3 in part 3
...
%% ################################################################# %% INITIAL SETTINGS / INPUTS
    ...
    config.fig_key_off      = 0; % set this to 1 to suppress display of trials/digital keypresses in an interactive UI
    ...
    fig_vis                = 'on'; % set to 'on' to see figures as they are generated and saved, set to 'off' to suppress this (faster)
